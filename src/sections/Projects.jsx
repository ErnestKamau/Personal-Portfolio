                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className='bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow'>
                            ...
                            <div className='p-6'>
                                ...
                                <p className='px-2 font-extralight mb-3 text-sm'>This project demonstrates a CLI application design, (SQLAlchemy)ORM-based data modelling, Relationship configuration(defining how tables and their corresponding Python classes are related), services layer abstraction, and database migration management, all within a Python environment.</p>
                                <div className='flex flex-wrap gap-2 mb-4'>
