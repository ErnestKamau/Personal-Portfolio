                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                            ...
                            <div className='p-6'>
                                ...
                                <p className='px-3 font-light text-sm mb-3'>Shirikisha is a full-stack web platform that digitizes and streamlines the management of Kenyan chamas (investment groups). The system enables users to create, join, and manage groups, track contributions, schedule meetings, make announcements, and assign roles.</p>
